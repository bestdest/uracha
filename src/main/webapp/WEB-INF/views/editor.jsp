...
<body>
    ...
    *********************************************************************************************************************************************************** --> 
    ...
    <jsp:include page="left.jsp" flush="true">
		<jsp:param name="active" value="editor"></jsp:param>
	</jsp:include> 
    <!-- **********************************************************************************************************************************************************
    MAIN CONTENT
    *********************************************************************************************************************************************************** --> 
	...
	<h3>
		<i class="fa fa-angle-right"></i> Discover Our Panels
	</h3>
	<div class="row mt">
		<div class="col-lg-12">
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-4 col-sm-4 mb">
					...
					<div class="white-panel pn">
						...
						<p>
							<img src="../resources/img/ui-zac.jpg" class="img-circle" width="50">
						</p>
						<p>
							<b>Zac Snider</b>
						</p>
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-4 col-sm-4 mb">
					<div class="steps pn">
						<input id='op1' name='op1' type='checkbox' checked /> <label for='op1'>Update Profile</label> 
						<input id='op2' name='op2' type='checkbox' /> <label for='op2'>Contact Paul</label> 
						<input id='op3' name='op3' type='checkbox' /> <label for='op3'>Enjoy Life</label> 
				...
				<div class="col-lg-4 col-md-4 col-sm-4 mb">
					<div class="content-panel pn">
						...
						<div class="centered">
							<h6>
								<i class="fa fa-envelope"></i><br />SHARON@DASHGUMTHEME.COM
							</h6>
						</div>
					</div>
					<!--/content-panel -->
						...
						<div class="stock current-price">
							<div class="row">
								...
								<div class="changes col-sm-6 col-xs-6">
									<div class="value up">
										<i class="fa fa-caret-up hidden-sm hidden-xs"></i> 694.00
									</div>
				...
				<div class="col-lg-4 col-md-4 col-sm-4 mb">
					<div class="weather-2 pn">
						...
						<div class="row centered">
							<img src="../resources/img/ny.jpg" class="img-circle" width="120">
						</div>
						<div class="row data">
							<div class="col-sm-6 col-xs-6 goleft">
								<h4>
						...
						<div class="info">
							<div class="row">
								...
								<div class="col-sm-6 col-xs-6 pull-left">
									<p class="goleft">
										<i class="fa fa-tint"></i> 13%
									</p>
								</div>
								<div class="col-sm-6 col-xs-6 pull-right">
									<p class="goright">
										<i class="fa fa-flag"></i> 15 MPH
									</p>
								</div>
							</div>
						</div>
