     <!--header start-->
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="/maker/dashboard/" class="logo"><b>DASHBOARD</b></a>
            <!--logo end-->
                ...
                <ul class="nav top-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu extended tasks-bar">
                            ...
                            <li>
                                <p class="green">작성하신 글중 가장 많은 view Top4</p>
                            </li>
                            <li>
                                <a href="index.html#">
                                    <div class="task-info">
                                ...
                                <a href="index.html#">
                                    ...
                                    <div class="progress progress-striped">
                                        <div class="progress-bar progress-bar-danger" role="progressbar" aria-valuenow="12" aria-valuemin="0" aria-valuemax="100" style="width: 12%">
                                            <span class="sr-only">12% Complete (Important)</span>
                                        </div>
                                    </div>
                                </a>
                            </li>
